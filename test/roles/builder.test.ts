...
describe('builder', () => {
  ...
  describe('hostile structure handling', () => {
    // The builder no longer dismantles hostile structures — that responsibility
    // was moved to cleanupClaimedRoom() in construction.ts (v1.0.221).
    // Builders simply ignore hostile structures and proceed with their build queue.

    it('does NOT dismantle a hostile extension even when in range', () => {
    ...
    it('proceeds to normal build logic when hostile structures are present', () => {
      const site = {
